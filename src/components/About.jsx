				...
				<div className="flex lg:flex-row flex-col w-full justify-center">
					<div className="w-full h-full flex justify-center items-center mt-5 lg:mx-3">
						<div className="bg-gray-100 rounded-xl mt-2 border border-gray-300 text-gray-800 lg:overflow-hidden flex items-center flex-col h-72 text-center mb-2">
							...
							<div className="p-4 flex justify-center items-center flex-col">
								<div className="mb-2">
									<DevicesIcon className="text-yellow-500" style={{ fontSize: "90px"}} />
								</div>
					...
					<div className="w-full h-full flex justify-center items-center mt-5 lg:mx-3">
						<div className="bg-gray-100 rounded-xl mt-2 border border-gray-300 text-gray-800 lg:overflow-hidden flex items-center flex-col h-72 text-center mb-2">
							...
							<div className="p-4 flex justify-center items-center flex-col">
								<div className="mb-2">
									<FlashOnIcon className="text-purple-500" style={{ fontSize: "90px"}} />
								</div>
								<p className="text-black">
					...
					<div className="w-full h-full flex justify-center items-center mt-5 lg:mx-3">
						<div className="bg-gray-100 rounded-xl mt-2 border border-gray-300 text-gray-800 lg:overflow-hidden flex items-center flex-col h-72 text-center mb-2">
							...
							<div className="p-4 flex justify-center items-center flex-col">
								<div className="mb-2">
									<DynamicFeedIcon className="text-blue-500" style={{ fontSize: "90px"}} />
								</div>
								<p className="text-black">
					...
					<div className="w-full h-full flex justify-center items-center mt-5 lg:mx-3">
						<div className="bg-gray-100 rounded-xl mt-2 border border-gray-300 text-gray-800 lg:overflow-hidden flex items-center flex-col h-72 text-center mb-2">
							...
							<div className="p-4 flex justify-center items-center flex-col">
								<div className="mb-2">
									<SecurityIcon className="text-green-600" style={{ fontSize: "90px"}} />
								</div>
								<p className="text-black">
